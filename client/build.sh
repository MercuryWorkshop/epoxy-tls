...
RUSTFLAGS='-Zlocation-detail=none' cargo build --target wasm32-unknown-unknown -Z build-std=panic_abort,std -Z build-std-features=panic_immediate_abort,optimize_for_size --release "$@"
...
wasm2js out/epoxy_client_bg.wasm > out/epoxy_client_bg.wasm.js
sed -i "s/import \* as wbg from 'wbg';/var wbg = globalThis.EPOXY_WASM2JS_IMPORTS;/" out/epoxy_client_bg.wasm.js

echo "[epx] wasm2js finished"
...
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//'epoxy_client.wasm'/'epoxy.wasm.js'}
...
# disable wasm stuff
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//if (typeof input === $'\''string/if (false $'&&' typeof input === $'\''string}
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//const $'{ instance, module }' = await __wbg_load(await input, imports);/globalThis.EPOXY_WASM2JS_IMPORTS=imports.wbg;}
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE/__wbg_finalize_init(instance, module);/}
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//__wbg_finalize_init(instance, module);/__wbg_finalize_init($'{ exports: await import(input) }, \"this build of epoxy is wasm2js\"');}

echo "$AUTOGENERATED_SOURCE" > pkg/epoxy.js

WASM_BASE64=$(base64 -w0 out/epoxy_client_bg.wasm.js)
AUTOGENERATED_SOURCE=${AUTOGENERATED_SOURCE//__wbg_init(input) \{/__wbg_init() \{$'\n'let input=\'data:application/javascript;base64,$WASM_BASE64\'}
...
cp out/epoxy_client_bg.wasm.js pkg/epoxy.wasm.js
